...
workflow_to_import_url = {
    ...
    'z6_atlas-import-webinar-recording' : "http://%s/@@import_webinar_recording" % HOSTNAME,
...
def importContent(context, event):
    ...
    if parent_review_state in ['atlas-import-article', 'atlas-import-video', 
                               ...
                               'atlas-import-online-course', 'z6_atlas-import-webinar',
                               'z6_atlas-import-webinar-recording']:
        return False
